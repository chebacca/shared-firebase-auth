    ...
    async createUserFromFirebase(firebaseUser) {
        try {
            ...
            try {
                ...
                const { getHubOrganizationId, getHubProjectId, validateHubOrganizationId, validateHubProjectId } = await import('shared-firebase-types');
                ...
                if (hubProjectId && hubProjectId !== 'null' && hubProjectId !== 'undefined') {
                    const validatedProjectId = validateHubProjectId(claims.projectAccess, claims.isOrganizationOwner || false);
